        ...
        {type === "login" ? (
          <Pressable onPress={()=>setModalVisible(false)} className="flex-1 justify-center items-center bg-black/[0.5]">
            <View className={`w-[80%] p-6 bg-white rounded-lg z-10`}>
              ...
              />
              <Text className="font-bold mt-4 mb-2">Senha:</Text>
              <TextInput
                className="border border-slate-300 px-3 py-2"
                value={password}
              ...
              <View className="flex-row justify-center items-center mt-4">
                ...
                <Pressable onPress={() => setType("register")}>
                  <Text className="font-bold"> Registrar</Text>
                </Pressable>
              </View>
              {loading
                &&
          ...
          <Pressable onPress={()=>setModalVisible(false)} className="flex-1 justify-center items-center bg-black/[0.5]">
            <View className={`w-[80%] p-6 bg-white`}>
              <Text className="font-bold mb-2">Nome:</Text>
              <TextInput
                className="border border-slate-300 px-3 py-2"
                value={name}
              ...
              <TextInput
                ...
                keyboardType="email-address"
              />
              <Text className="font-bold mb-2">Senha:</Text>
              <TextInput
                className="border border-slate-300 px-3 py-2"
                value={password}
                onChangeText={setPassword}
